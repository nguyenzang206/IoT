...
ESP32 là vi điều khiển (microcontroller) có thể đọc cảm biến, xử lý dữ liệu, điều khiển LED, điều khiển relay, điều khiển motor, kết nối WI-FI, giao tiếp Bluetooth, gửi dữ liệu lên Internet, .....
